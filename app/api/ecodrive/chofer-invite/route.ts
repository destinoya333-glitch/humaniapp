/**
 * Endpoint público que envía template eco_chofer_invite al wa_id
 * que llegó desde la landing /se-chofer-eco. Sin auth — rate limited
 * por IP en el siguiente sprint.
 */
...
export async function POST(req: NextRequest) {
  ...
  // Normalizar: si no empieza con 51 y tiene 9 digitos, agregar 51
      ...
      components: [
        {
          ...
          parameters: [
            {
              type: "action",
              action: { flow_token: `ecodrive:inscripcion-chofer:${normalized}` },
            },
          ],
        },
      ],
