...
const ADMIN_WHATSAPP = process.env.CLUB_ADMIN_WHATSAPP || "51998102258";
 ...
 *  { "path": "/api/cron/club-cerrar-edicion-completa", "schedule": "STAR/5 * * * *" }
 *
