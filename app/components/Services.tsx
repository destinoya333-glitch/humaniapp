const services = [
  ...
  },
  {
    ...
    name: "Mi Novia IA",
    description:
      "Compañía IA femenina con foto real, voz natural y personalidad única. Juanita te espera — escríbele cuando quieras.",
    features: ["Juanita — foto y voz reales", "Voz emocional con ElevenLabs", "Memoria persistente"],
    pricing: [
      ...
      { plan: "Plan Mensual ⭐",   price: "S/ 480",  note: "9 min/día · 30 días = 270 min · MÁS POPULAR" },
    ],
    cta: "Hablar con Juanita →",
    href: "https://wa.me/51979385499",
    highlight: null,
  },
  {
