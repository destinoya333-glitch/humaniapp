...
export const metadata: Metadata = {
  ...
  description: "Consultá tus tickets, Membresía y participación en sorteos EcoDrive+ Club.",
  ...
  return (
    <main className="min-h-screen bg-[#0A0A0A] text-white p-6">
      <div className="max-w-3xl mx-auto">
        ...
        <p className="text-gray-400 mb-6 text-sm">Consultá tus tickets y Membresía por WhatsApp.</p>
        <MiCuentaClient />
      </div>
    </main>
  );
